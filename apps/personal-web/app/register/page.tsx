    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <div className="animate-fade-in relative w-full max-w-sm rounded-2xl border border-white/[0.06] bg-white/[0.04] p-8 backdrop-blur-xl">
        ...
        <div className="relative">
          ...
          <p className="mt-1.5 text-sm text-white/40">Get started with your account</p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div>
              <label htmlFor="confirm" className="mb-1.5 block text-xs font-medium tracking-wide text-white/50 uppercase">
                Confirm password
              </label>
              <input
                id="confirm"
