        ...
        <header className="flex h-16 shrink-0 items-center gap-4 border-b border-gray-200 bg-white px-4 lg:px-6">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="block w-full rounded-lg border border-gray-200 bg-gray-50 py-2 pl-10 pr-3.5 text-sm text-gray-900 placeholder-gray-400 focus:border-primary-400 focus:ring-2 focus:ring-primary-500/20 focus:outline-none focus:bg-white transition-colors"
            />
          </div>
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-gray-200">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-primary-600 text-xs font-semibold text-white shadow-xs">
                JD
              </div>
