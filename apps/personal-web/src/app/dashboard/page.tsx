...
const recentOrders = [
  { id: "#3821", customer: "Olivia Martin", email: "olivia@example.com", product: "Premium Plan", amount: "$49.00", status: "Completed" },
  { id: "#3820", customer: "Ava Johnson", email: "ava@example.com", product: "Basic Plan", amount: "$19.00", status: "Pending" },
  { id: "#3819", customer: "Michael Chen", email: "michael@example.com", product: "Enterprise Plan", amount: "$199.00", status: "Completed" },
  { id: "#3818", customer: "Sarah Williams", email: "sarah@example.com", product: "Premium Plan", amount: "$49.00", status: "Processing" },
  { id: "#3817", customer: "James Wilson", email: "james@example.com", product: "Basic Plan", amount: "$19.00", status: "Completed" },
];
