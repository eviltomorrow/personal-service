...
func (c *financeClient) ListCategories(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListCategoriesResponse, error) {
...
func (UnimplementedFinanceServer) ListCategories(context.Context, *emptypb.Empty) (*ListCategoriesResponse, error) {
...
func _Finance_ListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FinanceServer).ListCategories(ctx, req.(*emptypb.Empty))
	}
