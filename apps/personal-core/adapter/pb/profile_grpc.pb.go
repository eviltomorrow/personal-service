...
const (
	Profile_GetProfile_FullMethodName    = "/personal.core.Profile/GetProfile"
	Profile_UpdateProfile_FullMethodName = "/personal.core.Profile/UpdateProfile"
)
...
type ProfileClient interface {
	GetProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*ProfileInfo, error)
...
func (c *profileClient) GetProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*ProfileInfo, error) {
...
type ProfileServer interface {
	GetProfile(context.Context, *GetProfileRequest) (*ProfileInfo, error)
...
func (UnimplementedProfileServer) GetProfile(context.Context, *GetProfileRequest) (*ProfileInfo, error) {
...
var Profile_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "personal.core.Profile",
	...
	Metadata: "apps/personal-core/adapter/profile.proto",
}
