...
import (
	...
	"github.com/eviltomorrow/personal-service/apps/personal-auth/pkg/service"
	"github.com/eviltomorrow/personal-service/apps/personal-auth/scripts"
)
...
func New(cfg *config.Config) (*Server, error) {
	...
	authSrv, err := service.NewAuth(cfg)
	if err != nil {
		return nil, fmt.Errorf("init auth service failure: %w", err)
	}
